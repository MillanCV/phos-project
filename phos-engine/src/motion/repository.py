...
class JsonMotionSessionRepository:
    ...
    def list_all(self) -> list[MotionSession]:
    ...
    @staticmethod
    def _serialize(session: MotionSession) -> dict[str, object]:
        return {
            "id": session.id,
    ...
    @staticmethod
    def _deserialize(item: dict[str, object]) -> MotionSession:
