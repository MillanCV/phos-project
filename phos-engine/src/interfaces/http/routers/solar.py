...
from src.interfaces.http.mappers.solar import to_solar_response, to_solar_summary
...
def solar_today(container: ApiContainer = Depends(get_container)) -> SolarWindowResponse:
