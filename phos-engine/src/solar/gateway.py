...
from src.solar.domain import PhotoWindows, SolarDay, SolarLocation, SolarWindow, TwilightTimes
...
class AstralSolarGateway:
    def __init__(self, location: SolarLocation, cache_file: Path) -> None:
        ...
        self._cache: dict[str, SolarDay] = self._load_cache()
    ...
    def _calculate_window(self, on_date: date) -> SolarDay:
    ...
    def _load_cache(self) -> dict[str, SolarDay]:
    ...
    @staticmethod
    def _has_extended_windows(window: SolarDay) -> bool:
        extended_fields = (
            window.civil_dawn,
            window.civil_dusk,
    ...
    @staticmethod
    def _serialize_window(window: SolarDay) -> dict[str, object]:
    ...
    @staticmethod
    def _deserialize_window(data: dict[str, object]) -> SolarDay:
